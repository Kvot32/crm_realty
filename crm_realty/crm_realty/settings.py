"""
Django settings for crm_realty project.
...
SECRET_KEY = 'django-insecure-p$#%#qytu90wb*cugox7@^n(nms3a_x9z8-l)+9z&@do1c%unh'
...
WSGI_APPLICATION = 'crm_realty.wsgi.application'
